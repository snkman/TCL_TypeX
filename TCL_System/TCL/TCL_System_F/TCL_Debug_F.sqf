	...
	while { (True) } do
	{
		...
		if (alive _object) then
		{
			...
			else
			{
				...
				_enemy = (_object findNearestEnemy _object);
				...
				_string = format ["%1<t align='center'><t color='#bebebe'>Group:</t> %2<br/><t color='#bebebe'>Unit:</t> %3<br/><t color='#bebebe'>Enemy:</t> %4<br/><t color='#bebebe'>Knowledge:</t> %5<br/><t color='#bebebe'>Behaviour:</t> %6<br/><t color='#bebebe'>Combat Mode:</t> %7<br/><t color='#bebebe'>Type:</t> %8<br/><t color='#bebebe'>Distance:</t> %9<br/></t>%10", _header, _group, _object, _enemy, _knowledge, (behaviour _object), (combatMode _object), (typeOf _object), (player distance _object), _text];
			};
